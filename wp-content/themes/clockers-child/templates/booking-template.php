                        ...
                        <div class="row">
                            <div class="col-md-5 book-hero__desc">
                                <div class="book-hero__text-holder">
                                    <h5 class="book__text"><?php echo get_field('banner_booking_title');?></h5>
                                    <p class="book__subtitle"><?php echo get_field('banner_booking_subtitle');?></p>
                                    ...
                                    <div class="form__box">
                                        <form action="#" method="post" id="wizard">
                                            ...
                                            <section class="book__step-one">
                                                ...
                                                <?php echo get_field('first_step_heading');?></h3>
                                                <div class="form-row">
                                            ...
                                            <section class="book__step-one second-tab">
                                                <h3 class="top__heading">
                                                <?php echo get_field('seconding_step_heading');?></h3>
                                                <div class="form-row">
                                            ...
                                            <section class="book__step-one last-tab">
                                                ...
                                                <div class="button__form">
                                                    <a href="<?php echo get_field('success_story_page_url');?>" class="form__button"><?php echo get_field('success_story_button_label');?></a>
                                                </div>
                                            </section>
                                            <p style="display: none;">
                                            <input type="hidden" name="action" value="cloker_booking_form_data">
                                             <input type="hidden" name="send_form_type" value="BookingData">
