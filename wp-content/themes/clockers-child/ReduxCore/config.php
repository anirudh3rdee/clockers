<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Clockers Theme Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Clockers Theme Options', 'redux-framework-demo' ),
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '<p>Use Global variable : <strong>$%1$s</strong></p>', 'redux-framework-demo' ), $v );
    } else {
        $args['intro_text'] = __( '<p>Use Global variable : <strong>$%1$s</strong></p>', 'redux-framework-demo' );
    }

    // Add content after the form.
    $args['footer_text'] = __( '<p>Thanks for using. Have a nice day...</p>', 'redux-framework-demo' );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'basic',
        'desc'             => __( 'Basic options for Header Section', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Top Header Stripe', 'redux-framework-demo' ),
        'id'               => 'top-header-stripe',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Manage option of top stripe header ', 'redux-framework-demo' ),
        'fields'           => array(
			array(
				'id'       => 'enable_top_stripe',
				'type'     => 'switch', 
				'title'    => __('Enable Top Stripe Header', 'redux-framework-demo'),
				'subtitle' => __('On / Off', 'redux-framework-demo'),
				'default'  => true,
			),

			array(
				'id'       => 'enable_language_translator',
				'type'     => 'switch', 
				'title'    => __('Enable Language Translator', 'redux-framework-demo'),
				'subtitle' => __('On / Off', 'redux-framework-demo'),
				'default'  => true,
			),

			array(
			    'id'       => 'top_header_phone_no',
			    'type'     => 'text',
			    'title'    => __('Enter Phone Number', 'redux-framework-demo'),
			    'subtitle' => __('Enter Phone Number for top stripe header.', 'redux-framework-demo'),
			    'desc'     => __('', 'redux-framework-demo'),
			    'default'  => '(+44) 0208 1919 6161'
			),

			array(
				'id'       => 'top_header_menu',
				'type'     => 'switch', 
				'title'    => __('Enable Top Header Navigation', 'redux-framework-demo'),
				'subtitle' => __('On / Off', 'redux-framework-demo'),
				'default'  => true,
			),
        )
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'default'  => array( 'url' => 'https://clockers.io/wp-content/uploads/2019/11/ClokersLogo.png' ),
            ),
            ...
            array(
                ...
                'compiler' => 'true',
                //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc'     => __( 'Upload Retina Logo Here', 'redux-framework-demo' ),
                'subtitle' => __( 'Upload any media using the WordPress native uploader', 'redux-framework-demo' ),
                'default'  => array( 'url' => 'https://clockers.io/wp-content/uploads/2019/11/ClokersLogo.png' ),
            ),
            ...
            array(
                ...
                'compiler' => 'true',
                //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc'     => __( 'Upload Mobile Logo Here', 'redux-framework-demo' ),
                'subtitle' => __( 'Upload Mobile Logo Here', 'redux-framework-demo' ),
                'default'  => array( 'url' => 'https://clockers.io/wp-content/uploads/2019/11/ClokersLogo-black.png' ),
            ),
              ...
              array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Mobile Retina Logo', 'redux-framework-demo' ),
                'compiler' => 'true',
                //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc'     => __( 'Upload Mobile Retina Logo Here', 'redux-framework-demo' ),
                'subtitle' => __( 'Upload Mobile Retina Logo Here', 'redux-framework-demo' ),
                'default'  => array( 'url' => 'https://clockers.io/wp-content/uploads/2019/11/ClokersLogo-black.png' ),
            ),
            ...
            array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Fevicon', 'redux-framework-demo' ),
                'compiler' => 'true',
                //'mode'      => false, // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc'     => __( 'Upload fevicon here', 'redux-framework-demo' ),
                'subtitle' => __( 'Upload fevicon here', 'redux-framework-demo' ),
                'default'  => array( 'url' => 'https://clockers.io/wp-content/uploads/2019/11/fevicon.png' ),
            ),

            array(
                'id'       => 'header_btn_text',
                'type'     => 'text',
                'title'    => __('Enter Header Button Text', 'redux-framework-demo'),
                'subtitle' => __('Enter text of header button.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'Book a FREE Scoping Session'
            ),

            array(
                'id'       => 'header_btn_link',
                'type'     => 'text',
                'title'    => __('Enter Header Button Link', 'redux-framework-demo'),
                'subtitle' => __('Enter link of header button.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'https://clockers.io/'
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'footer',
        'desc'             => __( 'Basic options for Footer Section', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-home'
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'footer_logo_text',
                'type'     => 'text',
                'title'    => __('Enter Footer Below Logo Text', 'redux-framework-demo'),
                'subtitle' => __('Enter text below logo.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'Get in contact with us and let’s see how we can help you.'
            ),

            array(
                'id'       => 'footer_logo_button_text',
                'type'     => 'text',
                'title'    => __('Enter Footer Below Logo Button Text', 'redux-framework-demo'),
                'subtitle' => __('Enter text below logo button.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'Let’s Talk'
            ),

            array(
                'id'       => 'footer_logo_button_link',
                'type'     => 'text',
                'title'    => __('Enter Footer Below Logo link', 'redux-framework-demo'),
                'subtitle' => __('Enter text below logo.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => ''
            ),
     ...
     Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'footer_top_text',
                'type'     => 'text',
                'title'    => __('Enter Footer Top Text', 'redux-framework-demo'),
                'subtitle' => __('Enter top text.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'Lets Talk'
            ), 
            ...
            array(
                'id'       => 'footer_top_email',
                'type'     => 'text',
                'title'    => __('Enter Footer Top Email', 'redux-framework-demo'),
                'subtitle' => __('Enter top Email.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'hello@clockers.io'
            ),

            array(
                'id'       => 'footer_top_phone',
                'type'     => 'text',
                'title'    => __('Enter Footer Top Phone Number', 'redux-framework-demo'),
                'subtitle' => __('Enter top Phone Number.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => '(+44) 0208 1919 6161'
            ),
            ...
            array(
                'id'       => 'footer_visit_us',
                'type'     => 'textarea',
                'title'    => __('Enter Visit Us content', 'redux-framework-demo'),
                'subtitle' => __('Enter Visit us content here', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => ''
            ),
            ...
            array(
                'id'       => 'footer_linkdin',
                'type'     => 'text',
                'title'    => __('Enter Linkdin page link', 'redux-framework-demo'),
                'subtitle' => __('Enter link of linkdin page here', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'LinkedIn'
            ),
     ...
     Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Manage option of Footer copyright Section ', 'redux-framework-demo' ),
        'fields'           => array(
            array(
                'id'       => 'footer_copyright',
                'type'     => 'text',
                'title'    => __('Enter Copyright Text', 'redux-framework-demo'),
                'subtitle' => __('Enter copyright text here.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => '© All reserved Rights.'
            ), 

            array(
                'id'       => 'footer_company_number',
                'type'     => 'text',
                'title'    => __('Enter Company Number', 'redux-framework-demo'),
                'subtitle' => __('Enter Company number here.', 'redux-framework-demo'),
                'desc'     => __('', 'redux-framework-demo'),
                'default'  => 'Company No. XXXXXX'
            ), 

            array(
				'id'       => 'copyright_menus',
				'type'     => 'switch', 
				'title'    => __('Enable Copyright Navigation (P&C T&C)', 'redux-framework-demo'),
				'subtitle' => __('On / Off', 'redux-framework-demo'),
				'default'  => true,
			),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'colors',
        'desc'             => __( 'Basic color options for website', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-home'
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
				array(
				    ...
				    'subtitle' => __('Pick a background color for the Header (default: #181818).', 'redux-framework-demo'),
				    'default'  => '#181818',
				    'validate' => 'color',
				),
